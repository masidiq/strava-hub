import { Box, Button, Flex, HStack, Skeleton, Tag, TagCloseButton, TagLabel, Text } from "@chakra-ui/react";
...
export default function FilterSection() {
  ...
  return (
    <>
      ...
      <Flex p="10px" px={{ base: "10px", md: "20px" }} justify="space-between" alignItems="center" position="sticky" top={{ base: "60px", md: "50px" }} zIndex="1">
        <Box></Box>
